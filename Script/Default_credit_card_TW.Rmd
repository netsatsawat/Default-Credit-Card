---
title: "Defaul Credit Card of Taiwan Clients in 2005"
Author: "Satsawat N."
output:
  html_document:
    code_folding: hide
...
raw.credit <- read.csv("UCI_Credit_Card.csv", header=T, sep=',', stringsAsFactors=F)
...
tmp <- read.csv("UCI_Credit_Card.csv", header=T, sep=',', stringsAsFactors=F)
